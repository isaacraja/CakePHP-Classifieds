<div id="content-center" class="prepend-1 span-16 append-1">
	...
	<?php //foreach ($data as $data):?> 
			<div id="post-item">
			  <div id="profile-user">
			    ...
			    <?php echo $html->image('posts/img_profilephoto.gif'); ?>
			    </div>
			  ...
			  <div id="post-item-rem">
			    <div id="post-item-title">
			     <h2>Maruti 800 Dx Used Car for Sale</h2> 
			    </div>
			    <div id="post-item-date">
			    Posted on Oodle - 2 days ago
			    </div>
			    <div id="post-item-image">
			<?php //echo $html->image(isset($data['Image'][0]['filename'])?'posts/'.$data['Image'][0]['filename']:'posts/nothumb.gif');
			echo $html->image('posts/1463323068u_0x.jpg',array('width' => 300));
			 ?>
			</div>			
			    <div id="post-item-detail">
			  
			      <span class="">Price: Rs 70,000</span><br />
			      <span class="">Summary: little know facts</span><br />
			      <span class="">Location: Chennai</span><br />
			      <span class="">For Sale By: Individual</span><br />
			    </div>
			  <div class="post-item-description">
			  <h3>Description</h3>
			  <p>Iam selling my Maruti 800 DX Car 1995 model, good running condition 60000 km done, 4th owner in chennai , all papers insurance and tax up todate,Genune buyers welcome , offered price Rs 70000 negotiable, Contact Jayaraj,Cell-9283135116</p>  
		  </div> 
